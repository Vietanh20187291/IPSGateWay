...
public enum CardEnum {
    ...
    FIELD4("F035.04","SVCCODE","Service Code - Fields 35.4"),
    FIELD5("F035.05","API","Account Parameter Index - Fields 35.5 (Usage 2)"),
    FIELD6("F035.06","API COUNTER","API Counter-Field 35.6 (Usage 4)"),
    FIELD7("F035.07","MSD VERIFICATION VAL","MSD Verification Value - Field 35.7 (Usage 3)"),
    FIELD8("F035.08","MST VERIFICATION VAL","MST Verification Value - Field 35.8 (Usage 4)"),
    FIELD9("F045","TRACK1 DATA","Track1 Data - Field 45"),
    FIELD10("F045.01","FORMAT CODE","Track1 Format Code - Field 45.1"),
    FIELD11("F045.02","Primary Account Number","Primary Account Number - 45.2"),
