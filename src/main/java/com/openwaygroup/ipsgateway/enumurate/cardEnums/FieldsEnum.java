...
public enum FieldsEnum {
    FIELD1("F002", "PAN", "Primary Account Number - Fields 2 and 35.1",13,19),
    FIELD2("F014", "EXPDATE", "Expiration Date - Fields 14, 35.3 and 45.6 (yymm)",4,4),
    FIELD3("F023", "CARD SEQ NUM", "Card Sequence Number - Field 23",3,3),
    FIELD4("F035", "TRACK2 DATA", "Track2 Data - Field 35",22,100),
...
//    FIELD9("F035.08","MST VERIFICATION VAL","MST Verification Value - Field 35.8 (Usage 4)"),
    FIELD10("F045", "TRACK1 DATA", "Track1 Data - Field 45",26,100),
...
//    FIELD19("F045.12.2","TRACK1 CVV","CVV - Field 45.12.2 (Usage 4)"),
    FIELD20("F052", "PIN DATA", "Personal Identification Number - Field 52",4,12),
...
//    FIELD48("F125.057", "MICRDATA4", "MICR Data Segment - Field 125.5 (POS Check)"),
    FIELD49("CVV2", "CVV2 Auth Data", "CVV2 Auth Data",3,3);
...
//    FIELD55("F152", "SECONDARY PIN DATA", "Secondary PIN Data - Field 152 - Tag CO (Chip)");
    ...
    FieldsEnum(String fieldId, String name, String description, int minLength, int maxLength) {
